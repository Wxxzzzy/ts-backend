...
namespace TSCore.Persistence.Migrations
{
    ...
    [Migration("20231210171901_commets-added")]
    partial class commetsadded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TSCore.Domain.Tables.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TSCore.Domain.Tables.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 10, 20, 19, 1, 189, DateTimeKind.Local).AddTicks(9980),
                            CreatedBy = "System",
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 12, 10, 20, 19, 1, 190, DateTimeKind.Local).AddTicks(53),
                            CreatedBy = "System",
            ...
            modelBuilder.Entity("TSCore.Domain.Tables.Comment", b =>
                {
                    b.HasOne("TSCore.Domain.Tables.User", "Sender")
                        .WithMany("UserComments")
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("TSCore.Domain.Tables.Ticket", "Ticket")
